...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset2("/packages/admin/AdminLTE/plugins/iCheck/square/blue.css") }}">
...
<!-- jQuery 2.1.4 -->
<script src="{{ asset2("/packages/admin/AdminLTE/plugins/jQuery/jQuery-2.1.4.min.js")}} "></script>
<!-- Bootstrap 3.3.5 -->
<script src="{{ asset2("/packages/admin/AdminLTE/bootstrap/js/bootstrap.min.js")}}"></script>
<!-- iCheck -->
<script src="{{ asset2("/packages/admin/AdminLTE/plugins/iCheck/icheck.min.js")}}"></script>
<script>
  $(function () {
    $('input').iCheck({
